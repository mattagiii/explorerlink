...
extern void WTimer0AIntHandler(void);   /* JSN */
extern void WTimer1AIntHandler(void);   /* remote start */
extern void WTimer2AIntHandler(void);   /* runtime stats */
extern void WTimer5AIntHandler(void);   /* JSN */
...
void (* const g_pfnVectors[])(void) =
{
    ...
    ADC0SS0IntHandler,                      //*ADC0 Sequence 0
    ADC0SS1IntHandler,                      //*ADC0 Sequence 1
